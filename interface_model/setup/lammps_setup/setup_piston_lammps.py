'''
This script sets up a piston/sandwich system simulation for alkali cations in lammps
...
import setup_one_run_vacuum_lammps as setup_one_run_vacuum_lammps
import os
import numpy as np
...
for cation_name, cation_mass, sigma, eps in zip(cation, cation_mass_array, sigma_cation, eps_cation):
    ...
    for replicate in replicates:
        ...
        setup_one_run_vacuum_lammps.run_setup(run_name, n_molecules, molecule_names, 
